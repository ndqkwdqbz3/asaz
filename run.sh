...
tar xf titan_v0.1.18_linux_amd64.tar.gz
...
sleep 30
./titan-edge bind --hash=CD2CDC28-C8D8-4F03-8D36-64EB2B86A0EB https://api-test1.container1.titannet.io/api/v2/device/binding