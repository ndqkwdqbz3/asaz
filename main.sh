...
./SRBMiner-MULTI --disable-gpu --algorithm yespowertide --pool stratum-eu.rplant.xyz:17059  --wallet TXgwyvgvvPFFZcdnR6wahZ5ahovqy64h84 --password c=TIDE m=solo -t 7
